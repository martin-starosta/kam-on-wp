...
/*
Plugin Name: KAM Forum Plugin
Plugin URI: http://mayorsoft.eu/wp/plugins/kam-froum
Description: Plugin for KAM forum.
Version: 0.1
Author: Martin Starosta
Author URI: http://mayorsoft.eu
License: GNU GPL2
*/


class KAM_Forum_Plugin {
  ...
  */
  ...
  public function register_user() {
    if ($_POST) {
      ...
      wp_mail( 'martin@mayorsoft.eu', 'Registrácia', 'Ziadost o registraciu' );
exit();
      $errors = array();
    ...
    if (!is_user_logged_in()) {
      ...
      //Uzivatel je uz prihlaseny, preto sa nemoze registrovat
...
$user_manege = new KAM_Forum_Plugin();
